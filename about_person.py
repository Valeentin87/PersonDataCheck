...
while flag:
    try:
        ...
        if len(person_data_list)>6:
            ...
            #result = f"<{check_surname((person_data_list)[0],check_gender(person_data_list)[0])[0]}> " \
                   # "<{name_person}><{}"
            
            firt_Person =  Person(check_surname(person_data_list,check_gender(person_data_list)[0])[0],name_person[0],check_patronymic(person_data_list, check_gender(person_data_list)[0])[0],check_phone_number(person_data_list)[0], \
